...
import com.eth.filecoin.common.crypto.jce.ECKeyAgreement;
import com.eth.filecoin.common.crypto.jce.ECKeyFactory;
import com.eth.filecoin.common.crypto.jce.ECKeyPairGenerator;
import com.eth.filecoin.common.crypto.jce.ECSignatureFactory;
import com.eth.filecoin.common.crypto.jce.FilCastleProvider;
...
public class ECKey implements Serializable {
     ...
     */
    private ECPoint extractPublicKey(final ECPublicKey ecPublicKey) {
     ...
     */
    private boolean isECPrivateKey(PrivateKey privKey) {
     ...
     * @return -
     */
    public ECKey fromPrivateAndPrecalculatedPublic(BigInteger priv,
                                                          ECPoint pub) {
     ...
     * @return -
     */
    public ECKey fromPrivateAndPrecalculatedPublic(byte[] priv, byte[]
            pub) {
     ...
     * @return -
     */
    public ECKey fromPublicOnly(ECPoint pub) {
     ...
     * @return -
     */
    public byte[] publicKeyFromPrivate(BigInteger privKey, boolean
            compressed) {
     ...
     */
    public ECKey fromNodeId(byte[] nodeId) {
    ...
    public byte[] signatureToKeyBytes(byte[] messageHash, String
    ...
    public byte[] signatureToKeyBytes(byte[] messageHash,
        ...
        int recId = header - 27;
        byte[] key = this.recoverPubBytesFromSignature(recId, sig,
                messageHash);
        if (key == null) {
     ...
     * @return ECKey
     */
    public ECKey signatureToKey(byte[] messageHash, String
            signatureBase64) throws SignatureException {
     ...
     * @return ECKey
     */
    public ECKey signatureToKey(byte[] messageHash, ECDSASignature
     ...
     */
    @Nullable
    public ECKey recoverFromSignature(int recId, ECDSASignature sig,
                                             byte[] messageHash) {
    ...
    public static class ECDSASignature {
        ...
        public boolean validateComponents(BigInteger r, BigInteger s,
                                                 byte v) {
